...
public class ArticleResponseParserTests
{
    ...
    [
        ...
        [
            ...
            new[]
            {
                "Path: pathost!demo!whitehouse!not-for-mail", "From: \"Demo User\" <nobody@example.net>", "", "This is just a test article (1).",
                "With two lines."
            },
            new XSerializable<NntpArticle>(new NntpArticle(123, "<123@poster.com>", null,
                new MultiValueDictionary<string, string>
                {
                    { "Path", "pathost!demo!whitehouse!not-for-mail" }, { "From", "\"Demo User\" <nobody@example.net>" },
        ...
        [
            ...
            new[] { "Multi: line1", " line2", " line3", "Path: pathost!demo!whitehouse!not-for-mail" },
            new XSerializable<NntpArticle>(new NntpArticle(123, "<123@poster.com>", null,
                new MultiValueDictionary<string, string> { { "Multi", "line1 line2 line3" }, { "Path", "pathost!demo!whitehouse!not-for-mail" }, },
                new List<string>(0)))
        ],
        [
            221, "123 <123@poster.com>", (int)ArticleRequestType.Head,
            ...
            new XSerializable<NntpArticle>(new NntpArticle(123, "<123@poster.com>", null,
                new MultiValueDictionary<string, string> { { "Path", "pathost!demo!whitehouse!not-for-mail" }, }, new List<string>(0)))
        ]
    ];
