...
public interface INntpClientRfc3977
{
    ...
    /// <returns>A multi-line response containing the capabilities.</returns>
    Task<NntpMultiLineResponse> CapabilitiesAsync(CancellationToken cancellationToken);
    ...
    /// <returns>A multi-line response containing the capabilities.</returns>
    Task<NntpMultiLineResponse> CapabilitiesAsync(string keyword);
    ...
    Task<NntpModeReaderResponse> ModeReaderAsync();
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A mode reader response object.</returns>
    Task<NntpModeReaderResponse> ModeReaderAsync(CancellationToken cancellationToken);
    ...
    Task<NntpGroupResponse> GroupAsync(string group);
    ...
    Task<NntpLastResponse> LastAsync();
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A last response object.</returns>
    Task<NntpLastResponse> LastAsync(CancellationToken cancellationToken);
    ...
    Task<NntpNextResponse> NextAsync();
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A next response object.</returns>
    Task<NntpNextResponse> NextAsync(CancellationToken cancellationToken);
    ...
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> ArticleAsync(long number);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> ArticleAsync(long number, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> ArticleAsync(CancellationToken cancellationToken);
    ...
    /// <param name="messageId">The message-id of the article to received from the server.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> HeadAsync(NntpMessageId messageId);
    ...
    /// <param name="number">The number of the article to receive from the server.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> HeadAsync(long number);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> HeadAsync(long number, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> HeadAsync(CancellationToken cancellationToken);
    ...
    /// <param name="messageId">The message-id of the article to received from the server.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> BodyAsync(NntpMessageId messageId);
    ...
    /// <param name="number">The number of the article to receive from the server.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> BodyAsync(long number);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> BodyAsync(long number, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> BodyAsync(CancellationToken cancellationToken);
    ...
    Task<NntpStatResponse> StatAsync(NntpMessageId messageId);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A stat response object.</returns>
    Task<NntpStatResponse> StatAsync(NntpMessageId messageId, CancellationToken cancellationToken);
    ...
    /// <param name="number">The number of the article to receive from the server.</param>
    /// <returns>A stat response object.</returns>
    Task<NntpStatResponse> StatAsync(long number);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A stat response object.</returns>
    Task<NntpStatResponse> StatAsync(long number, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A stat response object.</returns>
    Task<NntpStatResponse> StatAsync(CancellationToken cancellationToken);
    ...
    Task<bool> PostAsync(NntpArticle article);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>true if the article was posted successfully; otherwise false.</returns>
    Task<bool> PostAsync(NntpArticle article, CancellationToken cancellationToken);
    ...
    Task<bool> IhaveAsync(NntpArticle article);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>true if the article was accepted; otherwise false.</returns>
    Task<bool> IhaveAsync(NntpArticle article, CancellationToken cancellationToken);
    ...
    Task<NntpMultiLineResponse> HelpAsync();
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response with a short summary of the available commands.</returns>
    Task<NntpMultiLineResponse> HelpAsync(CancellationToken cancellationToken);
    ...
    Task<NntpGroupsResponse> NewGroupsAsync(NntpDateTime sinceDateTime);
    ...
    Task<NntpStreamResponse<NntpMessageId>> NewNewsAsync(
        string wildmat,
        NntpDateTime sinceDateTime
    );
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A group origins response.</returns>
    Task<NntpGroupOriginsResponse> ListActiveTimesAsync(CancellationToken cancellationToken);
    ...
    /// <param name="wildmat">The wildmat to use for filtering the group names.</param>
    /// <returns>A group origins response.</returns>
    Task<NntpGroupOriginsResponse> ListActiveTimesAsync(string wildmat);
    ...
    Task<NntpMultiLineResponse> ListDistribPatsAsync();
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response object containing newsgroup distribution information.</returns>
    Task<NntpMultiLineResponse> ListDistribPatsAsync(CancellationToken cancellationToken);
    ...
    Task<NntpStreamResponse<NntpNewsgroupDescription>> ListNewsgroupsAsync();
    ...
    /// <param name="wildmat">The wildmat to use for filtering the group names.</param>
    /// <returns>A multi-line response containing a list of newsgroups available on the server.</returns>
    Task<NntpStreamResponse<NntpNewsgroupDescription>> ListNewsgroupsAsync(string wildmat);
    ...
    Task<NntpMultiLineResponse> OverAsync(NntpMessageId messageId);
    ...
    /// <param name="range">Only include article numbers within this range in the list.</param>
    /// <returns>A multi-line response containing header fields.</returns>
    Task<NntpMultiLineResponse> OverAsync(NntpArticleRange range);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response containing header fields.</returns>
    Task<NntpMultiLineResponse> OverAsync(CancellationToken cancellationToken);
    ...
    /// <returns>A multi-line response containing a description of the fields
    /// in the overview database for which it is consistent.</returns>
    Task<NntpMultiLineResponse> ListOverviewFormatAsync(CancellationToken cancellationToken);
    ...
    Task<NntpStreamResponse<NntpHeaderField>> HdrAsync(string field, NntpMessageId messageId);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response containing the specfied header fields.</returns>
    Task<NntpStreamResponse<NntpHeaderField>> HdrAsync(
        string field,
        NntpMessageId messageId,
        CancellationToken cancellationToken
    );
    ...
    /// <param name="range">Only include article numbers within this range in the list.</param>
    /// <returns>A multi-line response containing the specfied header fields.</returns>
    Task<NntpStreamResponse<NntpHeaderField>> HdrAsync(string field, NntpArticleRange range);
    ...
    /// <param name="field">The header field to retrieve.</param>
    /// <returns>A multi-line response containing the specfied header fields.</returns>
    Task<NntpStreamResponse<NntpHeaderField>> HdrAsync(string field);
    ...
    Task<NntpMultiLineResponse> ListHeadersAsync(NntpMessageId messageId);
    ...
    /// <returns>A multi-line response containg a list of header
    /// fields that may be retrieved using the HDR command.</returns>
    Task<NntpMultiLineResponse> ListHeadersAsync(NntpArticleRange range);
    ...
    /// <returns>A multi-line response containg a list of header
    /// fields that may be retrieved using the HDR command.</returns>
    Task<NntpMultiLineResponse> ListHeadersAsync(CancellationToken cancellationToken);
}
