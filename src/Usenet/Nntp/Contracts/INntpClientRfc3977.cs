...
public interface INntpClientRfc3977
{
    ...
    /// numbers in the newsgroup. When a group is supplied it is selected; when a
    /// range is also supplied only article numbers within that range are included.
    /// </summary>
    /// <param name="group">The name of the group to select. When omitted the currently selected group is used.</param>
    ...
    /// <summary>
    /// The <a href="https://tools.ietf.org/html/rfc3977#section-6.2.1">ARTICLE</a> command
    /// selects an article by number according to the arguments and
    /// presents the entire article (that is, the headers, an empty line, and
    /// the body, in that order) to the client.
    /// </summary>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> ArticleByNumberAsync(
        long number,
        CancellationToken cancellationToken = default
    );
    ...
    /// <summary>
    /// The <a href="https://tools.ietf.org/html/rfc3977#section-6.2.1">ARTICLE</a> command
    /// presents the entire current article (that is, the headers, an empty line, and
    /// the body, in that order) to the client.
    /// </summary>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> CurrentArticleAsync(CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> HeadByNumberAsync(
        long number,
        CancellationToken cancellationToken = default
    );
    ...
    /// that, if the article exists, the response code is 221 instead of 220
    /// and only the headers are presented (the empty line separating the
    /// headers and body MUST NOT be included). This variant operates on the current article.
    /// </summary>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> CurrentHeadAsync(CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> BodyByNumberAsync(
        long number,
        CancellationToken cancellationToken = default
    );
    ...
    /// that, if the article exists, the response code is 222 instead of 220
    /// and only the body is presented (the empty line separating the headers
    /// and body MUST NOT be included). This variant operates on the current article.
    /// </summary>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>An article response object.</returns>
    Task<NntpArticleResponse> CurrentBodyAsync(CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A stat response object.</returns>
    Task<NntpStatResponse> StatByNumberAsync(
        long number,
        CancellationToken cancellationToken = default
    );
    ...
    /// that, if the article exists, it is NOT presented to the client and
    /// the response code is 223 instead of 220.  Note that the response is
    /// NOT multi-line. This variant operates on the current article.
    /// </summary>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A stat response object.</returns>
    Task<NntpStatResponse> CurrentStatAsync(CancellationToken cancellationToken = default);
    ...
    /// database from a specified article or range of articles in the
    ...
    /// command provides access to specific fields from a specified article
    /// or range of articles in the currently selected newsgroup.
    /// </summary>
    ...
    /// <summary>
    /// The <a href="https://tools.ietf.org/html/rfc3977#section-8.5">HDR</a>
    /// command provides access to specific fields from the current article
    /// in the currently selected newsgroup.
    /// </summary>
    /// <param name="field">The header field to retrieve.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response containing the specfied header fields.</returns>
    Task<NntpStreamResponse<NntpHeaderField>> CurrentHdrAsync(
        string field,
        CancellationToken cancellationToken = default
    );
    ...
    /// retrieved using the HDR command for a specified article or range of articles.
    /// </summary>
    /// <param name="range">Only include article numbers within this range in the list.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    ...
    /// The <a href="https://tools.ietf.org/html/rfc3977#section-8.6">LIST HEADERS</a>
    /// command returns a list of fields that may be
    /// retrieved using the HDR command for an article specified by message-id.
    /// </summary>
    /// <param name="messageId">The message-id of the article to received from the server.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A text response containing a list of header
