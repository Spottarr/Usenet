...
public interface INntpClientCompression
{
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response object.</returns>
    Task<NntpMultiLineResponse> XzhdrByMessageIdAsync(
        string field,
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response object.</returns>
    Task<NntpMultiLineResponse> CurrentXzhdrAsync(
        string field,
        CancellationToken cancellationToken = default
    );
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A multi-line response object.</returns>
    Task<NntpMultiLineResponse> CurrentXzverAsync(CancellationToken cancellationToken = default);
}
