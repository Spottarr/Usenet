namespace Usenet.Util
{
    ...
    public static class HashCode
    {
        ...
        /// <summary>
        /// Combine the current hash code with the hash code of the specified object.
        /// </summary>
        ...
        /// Collections with the same elements in different order will yield different hash codes.
        /// </summary>
        ...
        /// dictionary. Dictionaries with the same keys and values may yield different hash codes because
